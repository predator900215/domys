"""
Django settings for domys project.
...
SECRET_KEY = "django-insecure-m=n0&9m9*s&r-*&wgcd^8#c$s=y((k^89f8r(_-*5xf2=z5v)w"
...
WSGI_APPLICATION = "domys.wsgi.application"
